...
from mappillary_classifier.gradcam_localization import generate_gradcam_for_directory
from mappillary_classifier.models import create_model
from mappillary_classifier.utils import get_device, load_checkpoint


def parse_args():
    parser = argparse.ArgumentParser(description="Generate Grad-CAM maps for images.")
...
def main():
    ...
    generate_gradcam_for_directory(
        model=model,
        model_name=args.model_name,
